...
if(isset($_POST['submit'])){
    ...
    if($check_c_old_pass==0){
        ...
        echo "<script>alert(' Your current password did not valid , Please try again')</script>";
    ...
    if($c_new_pass!=$c_new_pass_again){
        ...
        echo "<script>alert('Your new password did not match , Please try again')</script>";
